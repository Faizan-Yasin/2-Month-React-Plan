...
import { getUsers, getUserById, createUser, updateUser, deleteUser } from './api/userSevice'

const App = () => {

  const { data: users, loading: usersLoading, error: usersError } = useFetch(getUsers)
  const fetchUser = useCallback((signal) => getUserById(1, signal), [])
