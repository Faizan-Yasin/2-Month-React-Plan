...
const TodoInput = ({ theme, title, description, setTitle, setDescription, handleAdd, editId }) => {
    ...
    return (
        <div className={styles.form}>
            <input className={`${styles.input} ${theme ? styles.light : styles.dark}`} onChange={(e) => setTitle(e.target.value)} name='title' type="text" placeholder='Enter Task Title...' value={title} />
