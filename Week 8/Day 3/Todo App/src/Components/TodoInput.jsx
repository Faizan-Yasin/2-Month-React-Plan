...
const TodoInput = ({ theme, title, description, setTitle, setDescription, handleAdd, editId }) => {
    ...
    return (
        <div className={styles.form}>
            <input ref={titleInputRef} className={`${styles.input} ${theme ? styles.light : styles.dark}`} onChange={(e) => setTitle(e.target.value)} name='title' type="text" placeholder='Enter Task Title...' value={title} />
            <textarea className={`${styles.textarea} ${theme ? styles.light : styles.dark}`} onChange={(e) => setDescription(e.target.value)} name='description' type="text" placeholder='Enter Task Description...' value={description} />
