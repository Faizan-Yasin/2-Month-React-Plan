...
import { addTodo, changeInput, updateTodo } from '../redux/features/todosSlice'
...
const TodoInput = () => {
    ...
    return (
        <div className={styles.form}>
            <input className={`${styles.input} ${theme ? styles.light : styles.dark}`} onChange={handleChange} name='title' type="text" placeholder='Enter Task Title...' value={form.title} />
            <textarea className={`${styles.textarea} ${theme ? styles.light : styles.dark}`} onChange={handleChange} name='description' type="text" placeholder='Enter Task Description...' value={form.description} />
