...
import { START_EDIT, DELETE_TODO, TOGGLE_TODO } from '../reducers/todoActions'
    ...
    return (
        <div className={`${styles.itemcontainer} ${theme ? styles.light : styles.dark}`}>
            ...
            <div className={styles.itembuttonscontainer}>
                ...
                <button className={`${styles.itembutton} ${styles.itemeditcontainer} ${styles.button2}`} onClick={() => dispatch({ type: DELETE_TODO, payload: todo.id })}>
                ...
                <button className={`${styles.itembutton} ${styles.itemeditcontainer} ${styles.button3}`} onClick={() => dispatch({ type: TOGGLE_TODO, payload: todo.id })}>
