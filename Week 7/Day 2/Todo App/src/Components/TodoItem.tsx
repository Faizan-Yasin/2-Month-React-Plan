...
const TodoItem = ({ theme, todo, toggleTodo, handleUpdate, handleDelete }: TodoItemProps) => {
    return (
        <div className={`${styles.itemcontainer} ${theme ? styles.light : styles.dark}`}>
            ...
            <div className={styles.itembuttonscontainer}>
                <button className={`${styles.itembutton} ${styles.itemeditcontainer} ${styles.button1}`} onClick={() => handleUpdate(todo)}>
                ...
                <button className={`${styles.itembutton} ${styles.itemeditcontainer} ${styles.button2}`} onClick={() => handleDelete(todo.id)}>
                ...
                <button className={`${styles.itembutton} ${styles.itemeditcontainer} ${styles.button3}`} onClick={() => toggleTodo(todo.id)}>
